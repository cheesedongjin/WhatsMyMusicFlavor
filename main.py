...
MOOD_DESCRIPTION_MAP: Dict[str, str] = {
    "abstract": "추상적인 무드",
    "aggressive": "과감한 에너지",
    "angst": "거친 감정선",
...
INSTRUMENT_DESCRIPTION_MAP: Dict[str, str] = {
    "808": "808 베이스 웨이브",
    "bass": "두터운 베이스 라인",
    "drums": "라이브 드럼 질감",
...
class PreferenceSummarizer:
    ...
    MOOD_DESCRIPTIONS = MOOD_DESCRIPTION_MAP
...
class MusicTournamentGUI(QMainWindow):
    ...
    INSTRUMENT_DESCRIPTIONS = INSTRUMENT_DESCRIPTION_MAP
